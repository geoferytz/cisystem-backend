...
public class StockMovementGraphqlController {
	...
	public StockMovementGraphqlController(StockMovementRepository stockMovementRepository) {
	...
	public List<StockMovementDto> stockMovements(@Argument StockMovementFilter filter) {
